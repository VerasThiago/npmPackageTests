...
@thiagoveras/plugin-b/0.1.1 linux-x64 node-v10.19.0
...
_See code: [build/commands/helloB.ts](https://github.com/VerasThiago/npmPackageTests/blob/v0.1.1/build/commands/helloB.ts)_
<!-- commandsstop -->
